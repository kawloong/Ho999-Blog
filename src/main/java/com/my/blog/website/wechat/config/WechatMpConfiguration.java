package com.my.blog.website.wechat.config;

import com.my.blog.website.wechat.handler.*;
...
//        WxMpService wxMpService = new me.chanjar.weixin.mp.api.impl.apache.WxMpServiceImpl();
  ...
  public WxMpMessageRouter router(WxMpService wxMpService) {
    ...
    // 图片消息处理
    newRouter.rule().async(false).msgType(XmlMsgType.IMAGE).handler(imgHandler).end();
